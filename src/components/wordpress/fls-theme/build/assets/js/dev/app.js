const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../css/lightgallery.min.css"])))=>i.map(i=>d[i]);
import "./headerScroll.min.js";
import "./toggleSubMenu.min.js";
import "./updateBusinessStatus.min.js";
import "./dropdownLanguage.min.js";
import "./priceCalculator.min.js";
import { i as initCookieBanner } from "./cookieBanner.min.js";
...
if (document.querySelector("[data-hero-youtube][data-video-id]")) {
  __vitePreload(() => import("./loadVideoHero.min.js"), true ? [] : void 0, import.meta.url);
}
window.addEventListener("load", () => {
  if (document.querySelector(".counter__value")) {
    __vitePreload(() => import("./gigitsCounter.min.js"), true ? [] : void 0, import.meta.url).then((module) => {
...
window.addEventListener("load", () => {
  if (document.querySelector('input[type="file"][name="wheel_photos[]"]')) {
    __vitePreload(() => import("./uploadPhotos.min.js"), true ? [] : void 0, import.meta.url).then((module) => {
...
async function loadLightGalleryAssets() {
  if (!lightGalleryModulePromise) {
    lightGalleryModulePromise = __vitePreload(() => import("./lightgallery.es5.min.js"), true ? [] : void 0, import.meta.url);
  }
  if (!lightGalleryStylesPromise) {
    lightGalleryStylesPromise = __vitePreload(() => Promise.resolve({}), true ? __vite__mapDeps([0]) : void 0, import.meta.url);
  }
...
function initReviewMedia(sliderBlock, swiperInstance) {
  ...
  const mediaSwipers = /* @__PURE__ */ new Map();
